...
(function(root, factory) {
    ...
    $.fn.photoClip = function(option) {
        ...
        var defaultOption = {
            ...
            ok: "",
            outputType: "jpg",
            clockwiseBtn: "", //顺时针旋转90度按钮
            antiClockwiseBtn: "", //逆时针旋转90度按钮
            strictSize: false,
            loadStart: function() {},
    ...
    function photoClip(container, option) {
        ...
        option.antiClockwiseBtn && $(option.antiClockwiseBtn).on("click", function() {
            rotateCCW(0);
        })
        option.clockwiseBtn && $(option.clockwiseBtn).on("click", function() {
            rotateCW(0);
        })
