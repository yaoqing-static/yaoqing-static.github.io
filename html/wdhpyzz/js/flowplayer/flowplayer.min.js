    ...
    return function t(e, n, r) {
        ...
        4: [function (e, t, n) {
            ...
            var l, s, u = e("../flowplayer"), c = e("bean"), f = e("class-list"), d = e("extend-object"),
                p = e("../common"), m = document.createElement("video"), v = {
                    ...
                    return i.src = e.src, i.type = o(e.type), i.className = "fp-engine", i.autoplay = t ? "autoplay" : !1, i.preload = n, i.setAttribute("x-webkit-airplay", "allow"),i.setAttribute("id", "media"),i.setAttribute("airplay", "allow"),i.setAttribute("webkit-playsinline", "true"),i.setAttribute("playsinline", "true"),i.setAttribute("x5-video-player-type", "h5"),i.setAttribute("x5-video-player-fullscreen", "true"),i.setAttribute("x5-playsinline", ""),i.setAttribute("ontimeupdate", "myOntimeupdate(this)"),i.setAttribute("onended", "myOnended(this)"), r && (l = i), i
                };
            s = function (e, t) {
                function n(n, o, a) {
        ...
        17: [function (e, t, n) {
            ...
            i(function (e, t) {
                ...
                var g = (n("progress"), n("buffer")), h = n("elapsed"), y = n("remaining"), b = n("waiting"),
                    ...
                    S = n("timeline-tooltip"), C = a.css(w, "padding-top"), j = n("timeline"), O = u(j, e.rtl),
                    N = (n("volume"), n("fullscreen")), P = n("volumeslider"), A = u(P, e.rtl),
                ...
                e.on("ready", function (e, n, i) {
                    ...
                    var n = t.pageX || t.clientX, r = n - a.offset(j).left, i = r / a.width(j),
            ...
            !function (t, r, o) {
                ...
                var n, r = window, o = t[e], i = /[^\.]*(?=\..*)\.|.*/, a = /\..*/, l = "addEventListener",
                    ...
                    w = function (e, t, n) {
                        ...
                        if (o = u && t.replace(a, ""), o && x[o] && (o = x[o].base), !t || u) (l = u && t.replace(i, "")) && (l = v(l, ".")), P(e, o, n, l); else if (h(t)) P(e, null, t); else for (r in t)t.hasOwnProperty(r) && _(e, r, t[r]);
                        return e
                    }, I = function (e, t, r, o) {
                        var l, s, u, c, f, g, y;
                        {
                        ...
                        var r, o, l, s, u, c = v(t);
                        for (r = c.length; r--;)if (t = c[r].replace(a, ""), (s = c[r].replace(i, "")) && (s = v(s, ".")), s || n || !e[d])for (u = S.get(e, t, null, !1), n = [!1].concat(n), o = 0, l = u.length; l > o; o++)u[o].inNamespaces(s) && u[o].handler.apply(e, n); else D(w[t], t, e);
                        return e
                    }, U = function (e, t, n) {
        ...
        21: [function (t, n, r) {
            (function (t) {
                !function (o) {
                    ...
                    function p(e) {
                        var t, n, r, o, a, l, s, f, p, m, v = [], g = e.length, h = 0, y = N, b = O;
                    ...
                    function m(e) {
                        ...
                        for (r = o = w.length, o && w.push(P); g > r;) {
                            ...
                            for (h = r + 1, u - t > L((E - n) / h) && i("overflow"), n += (u - t) * h, t = u, l = 0; g > l; ++l)if (v = e[l], t > v && ++n > E && i("overflow"), v == t) {
                    ...
                    var w, x, E = 2147483647, k = 36, T = 1, S = 26, C = 38, j = 700, O = 72, N = 128, P = "-",
                        A = /^xn--/, D = /[^ -~]/, _ = /\x2E|\u3002|\uFF0E|\uFF61/g, I = {
        ...
        25: [function (t, n, r) {
            !function (t, o) {
                ...
                var e, t = Array, n = t.prototype, r = Object, o = r.prototype, i = Function.prototype, a = String,
                    l = a.prototype, s = Number, u = s.prototype, c = n.slice, f = n.splice, d = n.push, p = n.unshift,
                    m = n.concat, v = i.call, g = i.apply, h = Math.max, y = Math.min, b = o.toString,
                    w = "function" == typeof Symbol && "symbol" == typeof Symbol.toStringTag,
                    x = Function.prototype.toString, E = function (e) {
                        try {
                            return x.call(e), !0
                        } catch (t) {
                            return !1
                ...
                var S, C = RegExp.prototype.exec, j = function (e) {
                    try {
                        return C.call(e), !0
                    } catch (t) {
                        return !1
                ...
                var N, P = String.prototype.valueOf, A = function (e) {
                    try {
                        return P.call(e), !0
                    } catch (t) {
                        return !1
                ...
                var $ = v.bind(o.hasOwnProperty), R = v.bind(o.toString), z = v.bind(c), q = g.bind(c),
                    V = v.bind(l.slice), H = v.bind(l.split), X = v.bind(l.indexOf), B = v.bind(d),
                    Y = v.bind(o.propertyIsEnumerable), W = v.bind(n.sort), K = t.isArray || function (e) {
                ...
                I(n, {
                    forEach: function (t) {
                        var n, r = F.ToObject(this), o = J && N(this) ? H(this, "") : r, i = -1,
                    ...
                    map: function (n) {
                        var r, o = F.ToObject(this), i = J && N(this) ? H(this, "") : o, a = F.ToUint32(i.length),
                            l = t(a);
                    ...
                    filter: function (t) {
                        var n, r, o = F.ToObject(this), i = J && N(this) ? H(this, "") : o, a = F.ToUint32(i.length),
                            l = [];
                    ...
                    every: function (t) {
                        var n, r = F.ToObject(this), o = J && N(this) ? H(this, "") : r, i = F.ToUint32(o.length);
                ...
                n.reduce && (ee = "object" == typeof n.reduce.call("es5", function (e, t, n, r) {
                    ...
                    reduce: function (t) {
                        var n = F.ToObject(this), r = J && N(this) ? H(this, "") : n, o = F.ToUint32(r.length);
                ...
                I(n, {
                    indexOf: function (e) {
                        var t = J && N(this) ? H(this, "") : F.ToObject(this), n = F.ToUint32(t.length);
                        if (0 === n)return -1;
                        var r = 0;
                        for (arguments.length > 1 && (r = F.ToInteger(arguments[1])), r = r >= 0 ? r : h(0, n + r); n > r; r++)if (r in t && t[r] === e)return r;
                        return -1
                    }
                }, ne);
                ...
                I(n, {
                    splice: function (e, t) {
                        ...
                        var f, d = z(arguments, 2), p = d.length;
                        if (u > p) {
                ...
                I(r, {
                    keys: function (t) {
                        var n = e(t), r = Ne(t), o = null !== t && "object" == typeof t, i = o && N(t);
                        if (!o && !n && !r)throw new TypeError("Object.keys called on a non-object");
                        var l = [], s = be && n;
                        if (i && we || r)for (var u = 0; u < t.length; ++u)B(l, a(u));
                        if (!r)for (var c in t)s && "prototype" === c || !$(t, c) || B(l, a(c));
                ...
                if (Re || $e || !Ue) {
                    var ze = Math.pow(2, 31) - 1, qe = L(new Date(1970, 0, 1, 0, 0, 0, ze + 1).getTime());
                    Date = function (e) {
                        var t = function (n, r, o, i, l, s, u) {
                                ...
                                if (this instanceof e) {
                                    var d = s, p = u;
                                    if (qe && f >= 7 && u > ze) {
                                        var m = Math.floor(u / ze) * ze, v = Math.floor(m / 1e3);
                                        d += v, p -= 1e3 * v
                                    }
                            ...
                            r = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365], o = function (e, t) {
                                ...
                                var n = 0, r = t;
                                if (qe && r > ze) {
                                    var o = Math.floor(r / ze) * ze, i = Math.floor(o / 1e3);
                                    n += i, r -= 1e3 * i
                                }
                        ...
                        var u = function (t) {
                            var r = n.exec(t);
                            if (r) {
                                var a, l = s(r[1]), u = s(r[2] || 1) - 1, c = s(r[3] || 1) - 1, f = s(r[4] || 0),
                                    d = s(r[5] || 0), p = s(r[6] || 0), m = Math.floor(1e3 * s(r[7] || 0)),
                                    v = Boolean(r[4] && !r[8]), g = "-" === r[9] ? 1 : -1, h = s(r[10] || 0),
                                    y = s(r[11] || 0), b = d > 0 || p > 0 || m > 0;
                ...
                var Ve = u.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== 0xde0b6b3a7640080.toFixed(0)),
                    He = {
                        base: 1e7, size: 6, data: [0, 0, 0, 0, 0, 0], multiply: function (e, t) {
                            ...
                            for (var e = He.size, t = ""; --e >= 0;)if ("" !== t || 0 === e || 0 !== He.data[e]) {
                                var n = a(He.data[e]);
                        ...
                        if (r = "", 0 > n && (r = "-", n = -n), o = "0", n > 1e-21)if (i = He.log(n * He.pow(2, 69, 1)) - 69, l = 0 > i ? n * He.pow(2, -i, 1) : n / He.pow(2, i, 1), l *= 4503599627370496, i = 52 - i, i > 0) {
                ...
                var Je = "	\n\x0B\f\r   ᠎             　\u2028\u2029\ufeff", Qe = "​", et = "[" + Je + "]",
                    tt = new RegExp("^" + et + et + "*"), nt = new RegExp(et + et + "*$"),
