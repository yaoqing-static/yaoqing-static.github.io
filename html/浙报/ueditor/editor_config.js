...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imageUrl:"http://pic.weibopie.com/imgUpload/action/weixin/imageUp.php"
        ,imagePath:""
        //图片上传配置区
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            ['fullscreen', 'bold', 'italic', 'underline', '|', 
                       ...
                       'insertimage', '|',
                       'removeformat', 'forecolor', 'backcolor','|', 'insertvideo','link','unlink','insertvote','fontsize','fontfamily']
